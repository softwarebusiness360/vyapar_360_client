...
export default function Logo({ size = "md", to = "/", className = "", name = "Vyapar360", logoUrl = "" }) {
  ...
  return (
    ...
    >
      {logoUrl ? <img src={logoUrl} alt="" className={`${dims} rounded-xl object-cover shadow-glow`} /> : (
        <div className={`${dims} rounded-xl bg-gradient-to-br from-indigo-500 to-fuchsia-500 grid place-items-center shadow-glow`}>
